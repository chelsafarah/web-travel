                    ...
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            @forelse ($item->transaction_details as $detail)
                                                <tr>
                                                    <td>
                                                        <img src="https://ui-avatars.com/api/?name={{ $detail->username }}" class="avatar" alt="">
                                                    </td>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="#">
                                                            <img src="{{ url('frontend/images/ic_remove.png', $detail->id) }}" alt="">
                                                        </a>
                                                    </td>
                                                </tr>
                                            @empty
                            ...
                            <div class="member mt-3">
                                <h2>Add Member</h2>
                                <form action="{{ route('checkout-create', $item->id) }}" class="row row-cols-lg-auto" method="POST">
                                    @csrf
                                    <div class="col-6 col-lg-3">
                                        <label for="username" class="visually-hidden">Name</label>
                                        <input type="text" class="form-control mb-2 me-sm-2" name="username" id="inputUsername" placeholder="Username">
                                    </div>
                                    <div class="col-6 col-lg-3">
                                        <label for="nationality" class="visually-hidden">Name</label>
                                        <input type="text" class="form-control mb-2 me-sm-2" name="nationality" id="nationality" placeholder="Username">
                                    </div>
                                    <div class="col-6">
                                        <label for="is_visa" class="visually-hidden">Visa</label>
                                        <select name="is_visa" id="inputVisa" class="form-select mb-2 me-sm-2">
                        ...
                        <div class="card card-details card-right">
                            ...
                            <table class="trip-informations">
                                <tr>
                                    ...
                                    <td width="50%" class="text-end">{{ $item->transaction_details->count() }} Person</td>
                                </tr>
                                <tr>
